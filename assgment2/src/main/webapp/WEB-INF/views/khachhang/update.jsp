...
<form:form action="/khachhang/update" method="post" modelAttribute="khachhang">
    ...
    Trạng thái:
    <input type="radio" name="trangThai" ${khachhang.trangThai ? "checked":""}  value="true"/>Hoạt động
    <input type="radio" name="trangThai" ${khachhang.trangThai ? "":"checked"} value="false"/>Ngừng hoạt động
    <br/>
