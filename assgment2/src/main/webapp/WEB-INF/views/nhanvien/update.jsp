...
<body>
<h3>${message}</h3>
<form:form action="/nhanvien/update" method="post" modelAttribute="nhanvien">
    ...
    Trạng thái:
    <input type="radio" name="trangThai" ${nhanvien.trangThai ? "checked":""}  value="true"/>Admin
    <input type="radio" name="trangThai" ${nhanvien.trangThai ? "":"checked"} value="false"/>Nhân viên
    <br/>
