...
<body>
<form:form action="" method="post" modelAttribute="hoadonct">
    ...
    Trạng thái:
    <input type="radio" name="trangThai" ${hoadonct.trangThai ? "checked":""}  value="true"/>có
    <input type="radio" name="trangThai" ${hoadonct.trangThai ? "":"checked"} value="false"/>hết
    <br/>
</form:form>
</body>
</html>